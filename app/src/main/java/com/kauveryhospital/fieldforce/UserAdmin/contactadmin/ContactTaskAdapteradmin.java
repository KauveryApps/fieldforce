        ...
        holder.phonenum.setText(resultp.get("phonenum"));
         ...
         holder.updatecontact.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View v) {
                 ...
                 intent.putExtra("city", data.get(position).get("city_name"));
                 ...
                 intent.putExtra("state", data.get(position).get("state_name"));
                 ...
                 intent.putExtra("cont_corpid",data.get(position).get("cont_corpid"));
