...
public class LeaveApprovingActivityAdmin extends AppCompatActivity implements NetworkChangeCallback {
    RecyclerView cusappoint;
    CancelRequestAdapterAdmin adapter;
    ...
    String uname,fromdate,todate,status,employeeid,la_leaveid,cancelremarks;

    private NetworkChangeReceiver networkChangeReceiver;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leave_approving_admin);
        backarrow=findViewById(R.id.backarrow);
        networkChangeReceiver = new NetworkChangeReceiver(LeaveApprovingActivityAdmin.this);
        ...
        if(isConnected()){
            ...
            Toast.makeText(LeaveApprovingActivityAdmin.this, "check Internet connection", Toast.LENGTH_LONG).show();
        }

        backarrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LeaveApprovingActivityAdmin.this, TabbedActivity.class));
            }
        });

    }
    private void postdatastate() {
        final ProgressDialog loading = new ProgressDialog(LeaveApprovingActivityAdmin.this);
        ...
        jsonObject5.addProperty("sql","select uname,reasonforleave,fromdate,todate,status,la_leaveid,cancelremarks from la_leave where status='pending' or status='cancel'");
        ...
        call4.enqueue(new Callback<Exampleadmin>() {
            ...
            public void onResponse(Call<Exampleadmin> call, Response<Exampleadmin> response) {
                ...
                try {
                    for (int i = 0; i <numbers; i++) {
                        ...
                        cancelremarks=list.get(0).getResult().getRow().get(i).getCancelremarks();
                    ...
                    adapter = new CancelRequestAdapterAdmin(LeaveApprovingActivityAdmin.this, arraylist,uname,pswd);
                    cusappoint.setLayoutManager(new LinearLayoutManager(LeaveApprovingActivityAdmin.this));
            ...
            public void onFailure(Call<Exampleadmin> call, Throwable t) {
                Toast.makeText(LeaveApprovingActivityAdmin.this, "No Records Found", Toast.LENGTH_LONG).show();
            }
        });
